...
Obsidian has changed my workflow dramatically over the past year, I'm going to share with you today, how and why I'm commited to using it, hopefully, for ages.
...
Initially, I went with [Notion](https://notion.so), as it was familiar and somewhat effective, but it lacked certain features, it is often lagged, which was frustrating. Then, an idea struck. I remembered [Obsidian](obsidian.md) a tool that had been on my radar for a while. It was appealing, especially the idea of owning my files as plain markdown. Despite the learning curve looks complicated, I decided to dive in and see what I could make of it.
...
What are your experiences with managing information overload? Have you tried Obsidian or any other PKM tools? What setups have worked best for you? Share your thoughts and let's discuss further!
